...
RSCS_APP_ConnHandleNotEvt_t RSCSHandleNotification;

static const char a_GapDeviceName[] = {  'R', 'u', 'n', 'n', 'i', 'n', 'g', ' ', 'S', 'p', 'e', 'e', 'd', ' ', 'a', 'n', 'd', ' ', 'C', 'a', 'd', 'e', 'n', 'c', 'e' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[28] =
{
  7, AD_TYPE_COMPLETE_LOCAL_NAME, 'R', 'S', 'C', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_APPEARANCE, 0x00, 0x00 /* UNKNOWN_APPEARANCE */,
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x14, 0x18,
  11, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */,
};
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      RSCSHandleNotification.EvtOpcode = RSCS_DISCON_HANDLE_EVT;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      RSCSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DIS_APP_EvtRx(&DISHandleNotification);
      RSCS_APP_EvtRx(&RSCSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          RSCSHandleNotification.EvtOpcode = RSCS_CONN_HANDLE_EVT;
          DISHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          RSCSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          RSCS_APP_EvtRx(&RSCSHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          RSCSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          RSCS_APP_EvtRx(&RSCSHandleNotification);
...
void APPE_Button1Action(void)
{
  ...
  {
    RSCS_APP_SCCPCalibrationFailed();
  }
  else
  {
